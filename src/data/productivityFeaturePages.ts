...
export const productivityFeaturePages: Record<ProductivityFeatureKey, ProductivityFeaturePage> = {
  'automatic-activity-tracking': {
    ...
    heroLead: 'Meet Sundial—the quiet desktop companion that records work activity inside the schedule you control.',
    heroBody: 'Sundial creates a chronological application timeline, launches with the workday, detects configured idle periods, and stops recording outside scheduled hours. Employees can see exactly what is being captured.',
