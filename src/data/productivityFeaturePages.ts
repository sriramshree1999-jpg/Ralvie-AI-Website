...
export const productivityFeaturePages: Record<ProductivityFeatureKey, ProductivityFeaturePage> = {
  'automatic-activity-tracking': {
    ...
    heroLead: 'Understand how work happens without asking employees to manually start timers or recreate their day from memory.',
    heroBody: 'Ralvie AI Productivity captures relevant workplace activity in the background, helping employees and managers understand work time, applications, documents, projects, tasks, active and idle periods, and broader productivity patterns.',
    supporting: ['Automatic activity capture', 'Active & idle time', 'Work schedules', 'Offline tracking', 'Application insights', 'Work intelligence'],
    introEyebrow: 'Work intelligence without manual timers',
    introTitle: "Automatic time tracking that drives <em><span>better work decisions.</span></em>",
    introText: "Your team already creates the activity. Ralvie organizes it into clearer work context while employees stay focused on the work itself.",
    highlights: [
      ["monitor", "Application context", "Understand which applications support everyday work."],
      ["document", "Documents & windows", "Connect active workspaces with useful context."],
      ["clock", "Active & idle periods", "Review time patterns inside configured schedules."],
      ["refresh", "Offline continuity", "Synchronize supported activity after connectivity returns."],
      ["calendar", "Work schedules", "Respect regional hours, shifts, and flexible routines."],
      ["sparkles", "AI work intelligence", "Turn activity into project, task, and summary context."],
    ],
    stories: [
      { eyebrow: "Automatic workplace activity", title: "Understand what happens throughout the workday.", text: "Ralvie Sundial works quietly in the background to create a chronological activity history based on your organization’s settings.", points: ["See activity as a clear timeline", "Understand application usage", "Review work sessions without constant check-ins"] },
      { eyebrow: "Schedule-aware visibility", title: "Make tracking fit the way your organization works.", text: "Set workdays, start and end times, regional schedules, and idle thresholds so captured context reflects the real workplace.", points: ["Configurable working hours", "Team and regional schedules", "Transparent employee boundaries"] },
      { eyebrow: "From activity to outcomes", title: "Let the workday help explain itself.", text: "Connect captured activity with projects, tasks, AI-assisted timesheets, work summaries, dashboards, and reports.", points: ["AI project and task mapping", "Clearer timesheet review", "Structured daily and weekly summaries"] },
    ],
    ...
    process: ["Configure workplace rules", "Employees work normally", "Relevant activity is captured", "Work context is organized", "Teams review patterns and act"],
  ...
  'time-logs': {
    ...
    description: 'Turn daily workplace activity into clear, structured time records with Ralvie AI Productivity. Review tracked activity, logged work, projects, tasks, applications, and work-time patterns without rebuilding the day from memory.',
    eyebrow: 'AI-powered time logs',
    heroTitle: "Time Logs That Turn Daily Work Into <em><span>Clear Records.</span></em>",
    heroLead: "See how the workday actually happened.",
    heroBody: "Ralvie brings workplace activity, logged work, projects, tasks, applications, and time context together in one structured view—making it easier to review the day and understand where work time goes.",
    ...
    faqs: [['What are Ralvie Time Logs?', 'A structured historical view of relevant workplace activity and the context surrounding it.'], ['What is the difference between tracked and logged activity?', 'Tracked Activity is captured through Sundial; Logged Activity provides a structured work record.'], ['Do employees create every log manually?', 'No. Ralvie reduces manual reconstruction by using captured activity as context.'], ['Can Time Logs connect with projects and tasks?', 'Yes. Work history can be associated with relevant projects and task-level context.'], ['Can Time Logs help create timesheets?', 'Yes. Captured work history supports AI-assisted timesheet workflows.'], ['Can remote and hybrid teams use Time Logs?', 'Yes. Ralvie supports remote, hybrid, office-based, distributed, and project-based environments.']],
  ...
  'screen-captures': {
    ...
    heroLead: "Time records tell you when work happened. Screen Captures can add another layer of context.",
    heroBody: "When enabled and configured by your organization, Ralvie can capture visual workplace context that helps employees and managers better understand applications, projects, tasks, and the work behind the time record.",
  ...
  tasks: {
    ...
    heroLead: "Create tasks, organize responsibilities, monitor progress, and understand the actual work happening behind every assignment.",
    heroBody: "Ralvie connects tasks with projects, workplace activity, time records, AI-assisted mapping, summaries, and reports—giving teams a clearer view of how everyday work moves projects forward.",
  ...
  projects: {
    ...
    heroLead: "Projects shouldn’t live separately from the work happening behind them.",
    heroBody: "Ralvie connects projects with tasks, workplace activity, Time Logs, AI-assisted timesheets, work summaries, and productivity analytics—giving teams a clearer view of project execution.",
  ...
  dashboard: {
    ...
    heroLead: "Bring workplace activity, projects, tasks, time, applications, workload, and productivity trends together in one clear view.",
    heroBody: "Ralvie transforms everyday work data into useful visual insights, helping employees, managers, and project leaders understand how work happens, where effort is going, and what may need attention next.",
